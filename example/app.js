...
function setScanMode(value) {
  ...
  dia.addEventListener('click', function(e) {
    ...
    switch (e.index) {
      case 0:
        mode = linea.MODE_SINGLE_SCAN;
        break;
      case 1:
        mode = linea.MODE_MULTI_SCAN;
        break;
      case 2:
        mode = linea.MODE_MOTION_DETECT;
        break;
      case 3:
        mode = linea.MODE_SINGLE_SCAN_RELEASE;
        break;
      case 4:
        mode = linea.MODE_MULTI_SCAN_NO_DUPLICATES;
        break;
    }
